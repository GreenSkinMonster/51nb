...
public class DrawerHelper {
    ...
    public enum DrawerItem {
        ...
        ALL_FORUMS(Constants.DRAWER_ALL_FORUMS, R.string.title_drawer_all_forums, GoogleMaterial.Icon.gmd_dashboard),
        WARRANTY(Constants.DRAWER_WARRANTY, R.string.title_drawer_warranty, GoogleMaterial.Icon.gmd_laptop);
