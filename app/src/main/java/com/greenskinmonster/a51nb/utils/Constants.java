...
public class Constants {
    ...
    public static final int STATUS_FAIL_SEC_QUESTION = 10;
    ...
    public static final int DRAWER_NEW_POSTS = 1007;
    public static final int DRAWER_WARRANTY = 1008;
    public static final int DRAWER_SETTINGS = 10000;
    public static final int DRAWER_ALL_FORUMS = 10001;
    ...
    public static final String EXTRA_NOTI_COUNT = "noti_count";
