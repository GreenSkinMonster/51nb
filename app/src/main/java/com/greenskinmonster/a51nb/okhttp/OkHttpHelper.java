...
public class OkHttpHelper {
    ...
    public Response getResponse(String url, String tag) throws IOException {
        Request request = buildGetRequest(url, tag, getCacheControl(FORCE_NETWORK));
    ...
    public void asyncPost(String url, ParamsMap params, ResultCallback callback) {
        ...
        Request request;
        try {
            request = buildPostFormRequest(url, params, null);
        } catch (Exception e) {
            Logger.e(e);
